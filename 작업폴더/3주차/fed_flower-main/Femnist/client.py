...
def main(DEVICE):
    ...
    def load_data():
        ...
        with open("C:/Users/LeeKihoon/Federated_Learning/3주차/fed_flower-main/data/train/all_data_"+str(number)+"_niid_0_keep_0_train_9.json","r") as f:
            train_json = json.load(f)
        with open("C:/Users/LeeKihoon/Federated_Learning/3주차/fed_flower-main/data//test/all_data_"+str(number)+"_niid_0_keep_0_test_9.json","r") as f:
